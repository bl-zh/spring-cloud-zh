...
public class Apriori2 {
	 ...
	 * @return 
	 */  
	public static Map<String, Integer> findFrequentOneSets(ArrayList<String> dataList)  
	{  
	 ...
	 * @return 
	 */  
	public static Map<String, Integer> aprioriGen(Map<String, Integer> setMap)  
	{  
	 ...
	 * @return 
	 */  
	public static boolean hasInfrequentSubset(String candidateSet, Map<String, Integer> setMap)  
	{  
	 ...
	 * 对应的子集为空集，{D}，...，{A,B,C,D}。 
	 */  
	public static List<String> subset(String sourceSet)  
	{  
	 ...
	 * @return 
	 */  
	public static String expect(String stringA,String stringB)  
	{  
		String result = "";  
	...
	{  
		...
		Map<String, Double> relationRulesMap = getRelationRules(frequentSetMap);  
